...
exports['default'] = function (context) {
    ...
    var userInfo = command.valueForKey_onLayer_forPluginIdentifier('latexStr', context._latexSelected, 'latex-plugin');
    if (!userInfo) {
        context.document.showMessage('Please select an latex layer');
        return;
    }

    (0, _webui2['default'])(context, true);
};

var _webui = __webpack_require__(1);
...
exports['default'] = function (context, isCalledFromEditMenu) {
    var webUI = new _sketchModuleWebView2['default'](context, __webpack_require__(2), {
...
var _placeSvg = __webpack_require__(6);
